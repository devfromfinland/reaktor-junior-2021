  ...
  return (
    <div aria-label='homepage'>
      ...
      <ul>
        ...
        <li>Allow users to quickly check product availability information from a single UI with filters</li>
        <li>Improve User Experience and Loading Speed</li>
        <li>Allow users to use web app when offline, data will be updated once user has internet connection again</li>
        <li>Acceptable display in mobile (I didn't want to spend too much time on this)</li>
      </ul>
      ...
      <div style={{ marginTop: '40px', fontSize: '16px', color: 'rgb(24, 68, 126)' }}>
        Developed by <span style={{ fontWeight: 'bold' }}>Viet Phan</span> as part of the pre-assignment for junior developer position (
